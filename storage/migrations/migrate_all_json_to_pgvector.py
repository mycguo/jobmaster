#!/usr/bin/env python3
"""
Migrate all JSON data to pgvector.

This script migrates all existing JSON data (applications, questions, resumes,
companies, contacts, quick notes, concepts, practice sessions, resume versions)
to PostgreSQL + pgvector.

IMPORTANT: This script reads directly from JSON files, not from pgvector.
"""
...
def migrate_user_data(user_id: str, dry_run: bool = False):
    ...
    # Migrate JobSearchDB data - read directly from JSON files
    base_dir = Path(__file__).parent.parent.parent
    user_data_dir = base_dir / "user_data" / user_id
    job_search_dir = user_data_dir / "job_search_data"
    
    # Applications - read directly from JSON file
    ...
    # Companies - read directly from JSON file
    ...
    # Contacts - read directly from JSON file
    ...
    # Quick Notes - read directly from JSON file
    ...
    # Migrate InterviewDB data - read directly from JSON files
    interview_dir = user_data_dir / "interview_data"
    
    # Questions - read directly from JSON file
    ...
    # Concepts - read directly from JSON file
    ...
    # Practice Sessions - read directly from JSON file
    ...
    # Migrate ResumeDB data - read directly from JSON files
    resume_dir = user_data_dir / "resume_data"
    
    # Resumes - read directly from JSON file
    ...
    # Resume Versions - read directly from JSON file
